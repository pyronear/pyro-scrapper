"""Pipelines for downloading and storing alertwest images."""
...
class AlertwestImagePipeline(ImagesPipeline):
    ...
    def open_spider(self, spider):
        """Initialize counters and progress bar when the spider opens."""
        self.time = time.time()
    ...
    def close_spider(self, spider):
        """Report counters and close progress bar when the spider closes."""
    ...
    def get_media_requests(self, item, info):
        """Generate image download requests and update progress tracking.
    ...
    def media_failed(self, failure, request, info):
        """Track failed downloads and silence timeouts."""
    ...
    def file_path(self, request, response=None, info=None, item=None):
        """Return the output path for the downloaded image."""
